...
#
################################################################################
# /Users/valentin/Documents/MG5/2.6.6/madgraph/various/histograms.py ../HiggsDistribution_15k_and_150k_with_weights.HwU --titles=Higgs  y --rebin=2 --only_scale --keep_all_weights --out=higgs_rapidity
reset
...
set multiplot
set label "Higgs  y" font ",13" at graph 0.04, graph 1.05
...
set format y '10^{%T}'
set yrange [7.1142e-05:1.3583e+00]
...
plot \
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 2 using 1:6:7 with filledcurve ls 13 fs transparent solid 0.2 title 'PURENLO, scale variation',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 1 using 1:6:7 with filledcurve ls 12 fs transparent solid 0.2 title 'LO, scale variation',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 0 using 1:6:7 with filledcurve ls 11 fs transparent solid 0.2 title 'NLO, scale variation',\
'higgs_rapidity.HwU' index 2 using (($1+$2)/2):($3 >= 0 ? sqrt(-1) : abs($3)) ls 103 title '',\
'higgs_rapidity.HwU' index 2 using (($1+$2)/2):($3 < 0 ? sqrt(-1) : $3) ls 3 title 'PURENLO, central value, dynamical\_scale\_choice=0',\
'higgs_rapidity.HwU' index 1 using (($1+$2)/2):($3 >= 0 ? sqrt(-1) : abs($3)) ls 102 title '',\
'higgs_rapidity.HwU' index 1 using (($1+$2)/2):($3 < 0 ? sqrt(-1) : $3) ls 2 title 'LO, central value, dynamical\_scale\_choice=0',\
'higgs_rapidity.HwU' index 0 using (($1+$2)/2):($3 >= 0 ? sqrt(-1) : abs($3)) ls 101 title '',\
'higgs_rapidity.HwU' index 0 using (($1+$2)/2):($3 < 0 ? sqrt(-1) : $3) ls 1 title 'NLO, central value, dynamical\_scale\_choice=0'
#-- rendering subhistograms 'Relative scale and PDF uncertainty'
unset label
unset format
set yrange [-5.4597e-01:1.0960e+00]
...
plot \
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 2 using 1:(safe($6,$3,1.0)-1.0):(safe($7,$3,1.0)-1.0) with filledcurve ls 13 fs transparent solid 0.2 title '',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 1 using 1:(safe($6,$3,1.0)-1.0):(safe($7,$3,1.0)-1.0) with filledcurve ls 12 fs transparent solid 0.2 title '',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 0 using 1:(safe($6,$3,1.0)-1.0):(safe($7,$3,1.0)-1.0) with filledcurve ls 11 fs transparent solid 0.2 title '',\
0.0 ls 999 title '',\
'higgs_rapidity.HwU' index 2 using (($1+$2)/2):(safe($5,$3,1.0)-1.0) ls 3 title '',\
'higgs_rapidity.HwU' index 1 using (($1+$2)/2):(safe($5,$3,1.0)-1.0) ls 2 title '',\
'higgs_rapidity.HwU' index 0 using (($1+$2)/2):(safe($5,$3,1.0)-1.0) ls 1 title ''
#-- rendering subhistograms '(LOPURENLO)/(NLO central value) ratio'
unset label
unset format
set yrange [-4.5206e-01:1.4006e+00]
...
set label "(LOPURENLO)/(NLO central value)" font ",9" at graph 0.03, graph 0.13
plot \
1.0 ls 999 title '',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 4 using 1:6:7 with filledcurve ls 13 fs transparent solid 0.2 title '',\
 "<perl -pe 's/^\\s*(?<x1>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)\\s*(?<x2>[\\+|-]?\\d+(\\.\\d*)?([EeDd][\\+|-]?\\d+)?)(?<rest>.*)\\n/ $+{x1} $+{x2} $+{rest}\\n$+{x2} $+{x1} $+{rest}\\n/g' higgs_rapidity.HwU" index 3 using 1:6:7 with filledcurve ls 12 fs transparent solid 0.2 title '',\
'higgs_rapidity.HwU' index 4 using (($1+$2)/2):5 ls 3 title '',\
'higgs_rapidity.HwU' index 4 using (($1+$2)/2):3 ls 3 title '',\
'higgs_rapidity.HwU' index 3 using (($1+$2)/2):5 ls 2 title '',\
'higgs_rapidity.HwU' index 3 using (($1+$2)/2):3 ls 2 title ''

unset label

################################################################################
unset multiplot
!ps2pdf "higgs_rapidity.ps" &> /dev/null
!open "higgs_rapidity.pdf" &> /dev/null