...
Clear@intexp;
chopp[expr_,prec_]:=Chop[expr/.y_Symbol^a_/;a>prec->0,10^-(-2 Log[10,$PrecTarget $Offset])]
intexp[exp0_,var_,prec_]:=Module[{exp=chopp[exp0//Expand,prec],out},
out=exp/.var->v/.repint;
Chop[out-(out/.d->0)+(out/.d->0)v/.d->1/.v->var,10^-(-2 Log[10,$PrecTarget $Offset])]
]
